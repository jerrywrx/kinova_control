...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--controller", type=str, default="OSC_POSE_STOW", help="Choice of controller. Can be 'IK_POSE' or 'OSC_POSE' or 'OSC_POSE_STOW'"
    )
    ...
    new_dir = os.path.join(args.directory, time_stamp)
    # os.makedirs(new_dir)
