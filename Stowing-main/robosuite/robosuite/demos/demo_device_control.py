...
if __name__ == "__main__":
    ...
    parser.add_argument("--controller", type=str, default="osc_stow", help="Choice of controller. Can be 'ik' or 'osc'")
    ...
    elif args.controller == "osc_stow":
        controller_name = "OSC_POSE_STOW"
    else:
    ...
    cubeA_pos = np.array(env.sim.data.body_xpos[env.obj_body_id["cubeA"]])
    indicator_configs = {
    "name": "test",
    "type": "sphere",
    "size": [0.03],
    ...
    env = VisualizationWrapper(env, indicator_configs=indicator_configs)
    ...
    while True:
        ...
        env.viewer.num_cam = num_cam
        env.viewer.rendered_cam = 4
        env.render()
