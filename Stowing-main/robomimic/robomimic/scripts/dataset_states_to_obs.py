...
def dataset_states_to_obs(args):
    ...
    env = EnvUtils.create_env_for_data_processing(
        ...
        use_rgb_camera=args.use_rgb_camera,
        use_depth_camera=args.use_depth_camera,
        use_pcd_camera=args.use_pcd_camera,
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset",
        default='/home/haonan/Projects/Stowing/robosuite-1.2/robosuite/models/assets/demonstrations/1676918940_9659684_StowPush/demo.hdf5',
        type=str,
        # required=True,
    ...
    parser.add_argument(
        "--output_name",
        default='/home/haonan/Projects/Stowing/robosuite-1.2/robosuite/models/assets/demonstrations/1676918940_9659684_StowPush/image.hdf5',
        type=str,
        # required=True,
    ...
    parser.add_argument(
        ...
        type=bool,
        default=False,
        help="(optional) whether to use rgb images",
    )
    ...
    parser.add_argument(
        ...
        type=bool,
        default=False,
        help="(optional) whether to use depth images",
    )
    ...
    parser.add_argument(
        ...
        type=bool,
        default=True,
        help="(optional) whether to use point cloud observations",
    )
