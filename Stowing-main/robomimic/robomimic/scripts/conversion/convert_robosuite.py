...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset",
        type=str,
        default="/home/haonan/Projects/Stowing/robosuite-1.2/robosuite/models/assets/demonstrations/1674532569_564803/demo.hdf5",
    ...
    split_train_val_from_hdf5(hdf5_path=args.dataset, val_ratio=0.2)
